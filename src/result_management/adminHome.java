...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B.tech", "B.com", "BCA", "BBA", "MBA" }));
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_management/save.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String roll_no = (String)jTextField1.getText();
        String name = (String)jTextField2.getText();
        String gender = (String)jComboBox3.getSelectedItem();
        String father_Name = (String)jTextField3.getText();
        ...
        try{
            ...
            st.executeUpdate("insert into student(roll_no,course,branchName,name,gender,fatherName) values('"+roll_no+"','"+course+"','"+branch_Name+"','"+name+"','"+gender+"','"+father_Name+"')");
